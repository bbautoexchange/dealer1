...
export default function FinancePageHollywood({ go }: Props) {
  ...
  return <section className="page-frame wrap-wide">
    <div className="page-intro"><div><p className="garage-kicker">Payment planning</p><h1>FINANCE YOUR<br /><em>NEXT CHAPTER.</em></h1></div><p>Estimate the structure that works for you, then request a direct follow-up from a RetroDrive finance specialist.</p></div>
